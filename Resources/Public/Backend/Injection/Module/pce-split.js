import { IframePreview } from './preview-iframe.js'
...
class PceSplitModule {
    ...
    _attachSplit(previewUrl, focusUid, recordEditBase, returnUrlBase, pageUrlBase) {
        ...
        const iframePreview = new IframePreview(previewUrl, recordEditBase, returnUrlBase);
        const iframe = iframePreview.createElement();
        ...
        const notifyFocusedIframe = () => {
            ...
            if (uid) {
                ...
                try {
                    iframePreview.focusedUid = uid;
                    iframePreview.iframeElement.contentWindow?.postMessage({ type: "pce-scroll-to-uid", uid }, "*");
